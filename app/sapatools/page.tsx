...
export default function SapaToolsPage() {
  ...
  const tools: Tool[] = [
    ...
    },
    {
      ...
      description:
        "Tool drag & drop untuk membuat halaman website tanpa coding",
      icon: Globe,
      category: "Website",
      downloads: "3.2K",
      rating: 4.7,
    ...
    },
    {
      ...
      description:
        "Template bot WhatsApp untuk customer service otomatis dengan fitur lengkap",
      icon: MessageCircle,
      category: "Automation",
      downloads: "1.5K",
      rating: 4.6,
    ...
    },
    {
      ...
      description:
        "Tool untuk membuat brand identity lengkap dengan logo, warna, dan font",
      icon: Palette,
      category: "Design",
      downloads: "1.9K",
      rating: 4.7,
    ...
    },
    {
      ...
      description:
        "Template editing foto untuk konten media sosial yang menarik",
      icon: Camera,
      category: "Design",
      downloads: "2.7K",
      rating: 4.6,
    ...
    },
    {
      ...
      description:
        "Kit mockup untuk presentasi aplikasi mobile yang profesional",
      icon: Smartphone,
      category: "Design",
      downloads: "1.4K",
      rating: 4.8,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Koleksi lengkap tools praktis yang bisa langsung kamu gunakan,
              tanpa harus paham coding atau desain. Semua gratis, semua mudah,
              semua untuk bantu kamu mulai menyapa dunia digital.
            </p>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Kalau tools yang ada belum sesuai kebutuhan, cek SapaMarket untuk
            solusi custom atau konsultasi langsung dengan tim kami.
          </p>
