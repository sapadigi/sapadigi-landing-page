...
export default function SapaMarketPage() {
  ...
  const products: Product[] = [
    {
      ...
      description:
        "E-book komprehensif dengan strategi digital marketing yang terbukti efektif untuk usaha kecil",
      price: "Rp 49.000",
    ...
    },
    {
      ...
      description:
        "Koleksi 50+ slide template untuk presentasi bisnis yang profesional dan menarik",
      price: "Rp 35.000",
    ...
    },
    {
      ...
      description:
        "Template Excel untuk mengelola stok barang dengan fitur otomatis dan laporan lengkap",
      price: "Rp 25.000",
    ...
    },
    {
      ...
      description:
        "Template perencanaan konten lengkap dengan ide konten untuk 12 bulan",
      price: "Rp 30.000",
    ...
    },
    {
      ...
      description:
        "Paket lengkap untuk membangun identitas brand dari nol hingga siap implementasi",
      price: "Rp 75.000",
    ...
    },
    {
      ...
      description:
        "Video course lengkap untuk memulai bisnis digital dari nol hingga profit pertama",
      price: "Rp 199.000",
  ...
  const services: Service[] = [
    {
      ...
      description:
        "Jasa pembuatan website custom sesuai kebutuhan bisnis Anda dengan desain modern dan responsif",
    ...
    },
    {
      ...
      description:
        "Layanan desain logo profesional dengan konsep brand identity yang kuat dan memorable",
    ...
    },
    {
      ...
      description:
        "Jasa setup dan optimasi akun media sosial untuk bisnis dengan strategi konten yang tepat",
    ...
    },
    {
      ...
      description:
        "Pembuatan bot WhatsApp sesuai kebutuhan bisnis dengan fitur auto reply dan integrasi sistem",
    ...
    },
    {
      ...
      description:
        "Sesi konsultasi 1-on-1 untuk merancang strategi digital yang tepat untuk bisnis Anda",
    ...
    },
    {
      ...
      description:
        "Jasa foto produk berkualitas tinggi untuk kebutuhan e-commerce dan marketing",
  ...
  const currentCategories =
    activeTab === "produk" ? productCategories : serviceCategories;
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Etalase resmi produk digital dan jasa berkualitas yang dibuat
              langsung oleh tim Sapadigi. Bukan marketplace umum — ini karya
              yang dirancang khusus untuk bantu kamu mulai dari nol.
            </p>
          ...
          >
            ...
            <TabsContent value="produk">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredItems
                  .filter((item): item is Product => "image" in item)
                  .map((product, index) => (
                    <Card
                      key={index}
            ...
            <TabsContent value="jasa">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredItems
                  .filter((item): item is Service => "icon" in item)
                  .map((service, index) => (
                    <Card
                      key={index}
                      className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group cursor-pointer"
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Kalau produk dan jasa yang ada belum sesuai kebutuhan spesifik kamu,
            konsultasi langsung dengan tim kami untuk solusi yang tepat.
          </p>
